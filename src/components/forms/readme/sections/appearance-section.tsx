...
import { Palette, LayoutDashboard, Moon } from 'lucide-react';
import { FormSectionProps } from '@/types/readme-form';
import { CollapsibleFormSection, FormTextField, FormSelectField, FormSwitchField } from '@/components/forms/common';
import { GridWrapper } from '@/components/common';

export const AppearanceSection: React.FC<FormSectionProps> = ({
  isExpanded,
  onToggle,
}) => {
  const layoutOptions = [
