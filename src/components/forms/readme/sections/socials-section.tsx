...
import { FormTextField } from '@/components/forms/common';
import {
  Coffee,
  Github,
  Globe,
  ...
  return (
    <div className="space-y-6">
      <p className="text-sm text-muted-foreground">
        Add your social media profiles and professional links. These will be
        displayed as badges in your README.
      </p>
