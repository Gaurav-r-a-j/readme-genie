    ...
    <Card className={className}>
      <CardContent className={compact ? 'p-4' : 'p-6'}>
        <div className="space-y-4">
            ...
            {steps.map((step, index) => {
              ...
              return (
                ...
                >
                  {/* Step icon/number */}
                  <div
                    className={`relative z-10 flex-shrink-0 ${compact ? 'w-6 h-6' : 'w-8 h-8'} rounded-full border-2 flex items-center justify-center transition-colors ${
                      isCompleted
                  ...
                  <div className="flex-shrink-0">
                    {isCompleted && (
                      <Badge
                        variant="secondary"
                        className={`${compact ? 'text-xs px-1 py-0' : 'text-xs'} bg-green-100 text-green-700 dark:bg-green-900 dark:text-green-300`}
                      >
                        ✓
                      </Badge>
                    )}
                  ...
                  {index < steps.length - 1 && (
                    <div
                      className={`absolute ${compact ? 'left-5 top-8 w-0.5 h-2' : 'left-6 top-12 w-0.5 h-4'} transition-colors ${
          ...
          {/* Summary */}
          <div className={`${compact ? 'mt-4 pt-2' : 'mt-6 pt-4'} border-t`}>
